$(document).ready(function () {
  ...
  function arc_heart(x, y, z, m) {
    ...
    // ctx.fillText('你好',x, y - 3 * z, x - 5 * z, y - 15 * z, x - 25 * z, y - 15 * z);
    // ctx.fillText('你好',x - 55 * z, y - 15 * z, x - 55 * z, y + 22.5 * z, x - 55 * z, y + 22.5 * z);
    // ctx.fillText('你好',x - 55 * z, y + 40 * z, x - 35 * z, y + 62 * z, x, y + 80 * z);
    // ctx.fillText('你好',x + 35 * z, y + 62 * z, x + 55 * z, y + 40 * z, x + 55 * z, y + 22.5 * z);
    // ctx.fillText('你好',x + 55 * z, y + 22.5 * z, x + 55 * z, y - 15 * z, x + 25 * z, y - 15 * z);
    // ctx.fillText('你好',x + 10 * z, y - 15 * z, x, y - 3 * z, x, y);
